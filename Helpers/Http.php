<?php
// namespace October\Rain\Network;
...
final class Http_Helper
{
	...
	/**
	 * @var int The maximum timeout allowed.
	 */
	...
	public function send()
	{
		 ...
		 * Set request data
		 */
		if ($this->requestBody && in_array($this->method, [self::METHOD_POST, self::METHOD_PATCH, self::METHOD_PUT])) {
	 ...
	 * @return self
	 */
	public function timeout(int $timeout = self::MAX_TIMEOUT)
	{
