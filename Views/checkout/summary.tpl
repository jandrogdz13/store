...
<div class="container summary-template">
	<div class="row">
		<div class="col-12 col-sm-12 col-md-7 col-lg-7 main-col py-lg-0 px-lg-3 p-4">
			...
			<div class="row d-flex flex-column mt-5 d-flex justify-content-center align-items-center text-center">
				<a class="btn w-50 p-3" href="/"><i class="mr-2 bi bi-arrow-left"></i> {translate('BACK_TO_SOTRE', $module)}</a>
			</div>
		</div>
